                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Cap Masuk</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3>Riwayat Cap Masuk Jenis <?= $cap['warna'] . ' ' . $cap['nama_cap']; ?></h3>
                                <div class="row mt-5">
                                ...
                                <div class="card-body bg-warning">
                                    <h4 class="text-center">Tambah Data Masuk</h4>
                                    <form action="" method="post">
                                        ...
                                        <div class="row input-group col-md-12 mt-3">
                                            <label class="col-md-4 text-right">Jumlah Cap Masuk</label>
                                            <input type="number" class="form-control col-md-4" name="cap_masuk" min="0" required>
                                        </div>
                                ...
                                <table id="zero_config" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-weight: bold;">Jumlah Masuk</th>
