            ...
            <div class="auth-box bg-light">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?= base_url() ?>assets/img/kadujaya logo.png" alt="PT. Kadujaya Perkasa" style="width:100%" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Kode Petugas" name="kode_petugas" value="<?= set_value('kode_petugas'); ?>" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
